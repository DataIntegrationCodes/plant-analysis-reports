(async function () {
  ...
  document.title = `${plant.name} — Plant Analysis Reports V2`;
  ...
  function render(month) {
    ...
    body.innerHTML = PAR.renderPlantSectionsV2(plant.months[month]);
    waterfallChart = PAR.buildLossWaterfallChart(document.getElementById("chartLossWaterfall"), plant.months[month]);
    downloadBtn.href = `reports/${code}-v2/${month}.pdf`;
  }
